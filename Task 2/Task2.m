...
Eb = 1;
N0 = Eb/(10^(10/10));
AWGN = sqrt(N0)*randn(1,N*fs);
st_alpha0 = st_alpha0([1:10000]) + AWGN;
st_alpha5 = st_alpha5([1:10000]) + AWGN;
st_alpha1 = st_alpha1([1:10000]) + AWGN; 
...
figure;
plot([0:1/fs:1.99],st_alpha0_reshape.','b');   
title('eye diagram with Sinc');
xlabel('time')
ylabel('amplitude') 
axis([0 2 -1.5 1.5])
grid on
